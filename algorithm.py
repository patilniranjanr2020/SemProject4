...
def generate():
    ...
    colors = ['red', 'green', 'blue', 'yellow', 'orange', 'purple', 'cyan', 'magenta', 'pink', 'brown',
              'lightblue', 'lightgreen', 'lightyellow', 'lightpink', 'lightgray', 'darkred', 'darkgreen', 
    ...
    for bar in range(0, number):
        ...
        bar = canvas.create_rectangle(barstart, randomY, barend, 365, fill=color)
        barList.append(bar)
        barstart += 10
        barend += 10
